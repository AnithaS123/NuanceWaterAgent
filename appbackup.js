            ...
            if (msg.result_type === "NMDP_TTS_CMD" || msg.result_type === "NVC_TTS_CMD") {
                ...
                if (msg.result_format === "nlu_interpretation_results") {
                    ...
                    try {
                        ...
                        // try Anitha Nuance
                        if (msg.nlu_interpretation_results.payload.interpretations[0].literal === 'hi' ||
                            msg.nlu_interpretation_results.payload.interpretations[0].literal === 'hello' ||
                            msg.nlu_interpretation_results.payload.interpretations[0].literal === 'getting started' ||
                            msg.nlu_interpretation_results.payload.interpretations[0].literal === 'hey') {
                            // response has to bind

                            console.log("Looks like you are having issues with water appearance.");
                            let textRes = "Welcome to Water Services. Looks like you are having issues with water appearance.";

                            welcomeIntent.val(textRes);

                            console.log("Anitha");
                            //                           $.ajax({
                            //                             url:'http://localhost:7000/passdata',
                            //     dataType: 'json', // type of response data
                            //     data: JSON.stringi{'text' : textRes},
                            //     method : "POST",
